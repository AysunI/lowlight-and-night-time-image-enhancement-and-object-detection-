...
ANN_JSON     = "../../Exdark/resized_coco_json/instances_test.json"         
CKPT         = "../../Exdark/exdark_frcnn_outputs_nafnet/model_best.pth"  
SPLIT_TABLE  = "../../imageclasslist.txt"                          
OUT_DIR      = "../../Exdark/exdark_frcnn_outputs_nafnet/test_result"
SPLIT_NAME   = "test"                    
BATCH_SIZE   = 2
NUM_WORKERS  = 4
