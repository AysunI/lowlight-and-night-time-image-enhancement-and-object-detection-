...
train_json = '../../Exdark/Coco_output/exdark_train.json'
val_json = '../../Exdark/Coco_output/exdark_val.json'
test_json = '../../Exdark/Coco_output/exdark_test.json'
out_path = "../../Exdark/exdark_frcnn_outputs_zero-dce"
epochs = 12
USE_AMP = True
