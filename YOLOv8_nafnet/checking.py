...
dt_json = 'runs/detect/exdark_test_eval/predictions.json'
...
if fixed:
    json.dump(dt, open("runs/detect/exdark_test_eval/predictions_fixed.json","w"))
    print("Wrote fixed:", "runs/detect/exdark_test_eval/predictions_fixed.json")